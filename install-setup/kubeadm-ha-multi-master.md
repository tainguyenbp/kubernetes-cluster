...
kubeadm init --control-plane-endpoint "192.1268.1.1:6443" --upload-certs --apiserver-advertise-address=92.1268.1.2 --pod-network-cidr=10.244.0.0/16 --v=15
kubeadm init --control-plane-endpoint="92.1268.1.1:6443" --upload-certs --apiserver-advertise-address=92.1268.1.2 --pod-network-cidr=10.244.0.0/16 --v=15
```
